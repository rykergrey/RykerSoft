...
- **Post-Install User Guide**: After an install or update finishes, you return to that app’s detail view on the User Guide tab — App Manager stays open instead of sending you to the home screen.
