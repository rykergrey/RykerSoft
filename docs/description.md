...
- **Post-Install User Guide**: After an install or update finishes, you return to that app’s detail view on the User Guide tab — App Manager comes back to the foreground instead of leaving you on the home screen.
- **Reliable Play Protect flow**: Installs use PackageInstaller sessions with a dedicated confirmation host so Play Protect prompts stay visible and tappable.
